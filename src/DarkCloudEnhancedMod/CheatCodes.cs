    ...
    internal class CheatCodes
    {
        ...
        internal class InputBuffer
        {
            ...
            public enum Button
            {
                ...
                L1          = 0b0000000000000100,
                R1          = 0b0000000000001000,
                Triangle    = 0b0000000000010000,
                Circle      = 0b0000000000100000,
                Cross       = 0b0000000001000000,
                Square      = 0b0000000010000000,
                Select      = 0b0000000100000000,
                L3          = 0b0000001000000000,
                R3          = 0b0000010000000000,
                Start       = 0b0000100000000000,
                DPad_Up     = 0b0001000000000000,
                DPad_Right  = 0b0010000000000000,
                DPad_Down   = 0b0100000000000000,
                DPad_Left   = 0b1000000000000000,
