...
This changelog lists development changes by date with links to the corresponding commits.

For the original v1.00 feature list, see [FEATURES.md](FEATURES.md).
