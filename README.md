...
The mod is primarily built for Windows, with an in-progress Linux compatibility layer for process-memory access. PAL support is handled automatically at runtime.
